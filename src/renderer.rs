...
impl Renderer {
    ...
    pub async fn new(window: &winit::window::Window) -> Self {
        let instance = wgpu::Instance::new(wgpu::InstanceDescriptor {
            ...
            display: Some(Box::new(unsafe { &*(window as *const winit::window::Window)})),
        });
    ...
    pub fn render(&mut self) {
        let current_texture = match self
            .surface
            .get_current_texture() {
                ...
                wgpu::CurrentSurfaceTexture::Suboptimal(texture) => {
                    ...
                    self.surface.get_current_texture() {
                        ...
                        panic!("[ERROR] Two consecutive configuration of surface failed during rendering");
                    }
                },
                _ => {
                    panic!("[ERROR] Failed to get the current texture from the surface during rendering");
                }
            };
